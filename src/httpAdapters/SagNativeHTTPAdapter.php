...
{
    private $connPool = [];          //Connection pool
    ...
    public function procPacket($method, $url, $data = null, $reqHeaders = [], $specialHost = null, $specialPort = null)
    {
      ...
      (
        ...
        && $response->headers->{'transfer-encoding'} !== 'chunked') {
            ...
            } elseif (!empty($response->headers->{'transfer-encoding'})) {
                /*
